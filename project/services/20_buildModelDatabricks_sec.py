...
def trigger_training_job():
    ...
    response = requests.post(
        ...
        json={
                ...
                "notebook_task": {
                "notebook_path": notebook_remote_path,
                "base_parameters": [{"key":"model_name", "value":model_name_run},
                                    {"key":"stor2_name", "value":stor2_name},
                                    {"key":"stor2_container", "value":stor2_container},
                                    {"key":"stor2_train_file", "value":train_dataset},
                                    {"key":"stor2_test_file", "value":test_dataset},
    ...
    model = Model.register(
        ...
        description="LightGBM model from Kaggle 1st place, for Earthquake prediction",
        workspace=ws,
    )
